                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" id="main-content" style="overflow-y: auto;">
                            ...
                            <div class="col-md-12" id="list-div">
                                ...
                                <button class="btn btn-primary" id="<?php echo $i;?>" style="display: inline-block; margin: 0 0.5rem; margin-top: 1vh; margin-left: -20px;" disabled>Publish</button>    
                                </div>
                                <div class="col-1" style="margin-top: 1.3rem;">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="<?php echo $count;?>" name="<?php echo $count;?>" value="1">
                                    <label class="form-check-label" for="privacy">Public</label>
                                    </div>
                                </div>
                                <script>
                                    $(function () {
                                        $("input[name='<?php echo $count;?>']").click(function () {
                                            if($("#<?php echo $count; ?>").is(":checked")) {
                                                $("#<?php echo $i;?>").removeAttr("disabled");
                                            }
                                            else{
                                                $("#<?php echo $i;?>").attr("disabled", "disabled");
                                            }
                                        });
                                    });
                                    <?php
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <!-- <div class="text-body border" style=" border-radius: 10px; height: 7vh; margin-top: 1vh;"> -->
                                            <p class="text-bg-light" id="strat-desc" style="height: 80%; width: 95%; border-radius: 10px; overflow-y: auto; overflow-x: auto; font-size: 12px;"><?php echo $row['descr']; ?></p>
                                        <!-- </div> -->
                                        </div>
